...
void loop()
{
  ...
  //analogWrite(9,pw) // min speed 5% is 12.75 maximum speed is 10% duty cycle, value of 25.5. value of 255 is 100% duy cycle
  
  int passed = pulseIn(13,HIGH);
  
  xangleg = (passed/50) - 193;
